...
def load_model(output_dir, vocab_size=None, embedding_dim=None):
    model_path = output_dir / "cbow_model.pth"
    ...
    # If we don't have vocab_size or embedding_dim, we need to infer them from embeddings
    if vocab_size is None or embedding_dim is None:
        ...
        if embeddings is not None:
            ...
            print("Nelze určit velikost slovníku nebo embedding dimenze pro načtení modelu.")
            return None
